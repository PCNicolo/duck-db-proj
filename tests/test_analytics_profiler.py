...
class TestSummaryStatsGenerator:
    ...
    def test_generate_numeric_stats(self):
        ...
        stats = self.stats_generator._generate_numeric_stats(series, "test_col", "test_table")
    ...
    def test_generate_text_stats(self):
        ...
        stats = self.stats_generator._generate_text_stats(series, "test_col", "test_table")
        
        assert stats['count'] == 5
        assert stats['unique'] == 4  # 'hello', 'world', 'test', None (pandas counts NaN as unique)
        assert stats['missing'] == 0  # isnull().sum() on converted string series doesn't count None as missing
    ...
    def test_generate_date_stats(self):
        ...
        stats = self.stats_generator._generate_date_stats(series, "test_col", "test_table")
    ...
    def test_generate_boolean_stats(self):
        ...
        stats = self.stats_generator._generate_boolean_stats(series, "test_col", "test_table")
    ...
    def test_generate_generic_stats(self):
        ...
        stats = self.stats_generator._generate_generic_stats(series, "test_col", "test_table")
...
class TestDataProfiler:
    ...
    def setup_method(self):
        ...
        self.profiler.stats_generator.generate_statistics = Mock(return_value=mock_stats)
    ...
    def test_get_sample_values(self):
        ...
        assert len(sample_values) <= 5  # Our mock returns 5 values, not limited by LIMIT clause in this test
    ...
    def test_calculate_overall_quality(self):
        ...
        profiles = [
            ColumnProfile(
                ...
                statistics={},
                quality_metrics={'completeness': 0.9, 'uniqueness': 0.8, 'validity': 0.95},
                patterns={},
                sample_values=[]
            ),
            ColumnProfile(
                ...
                statistics={},
                quality_metrics={'completeness': 0.85, 'uniqueness': 0.6, 'validity': 0.9},
                patterns={},
                sample_values=[]
            )
        ]
    ...
    def test_profile_table_integration(self):
        ...
        revenue_profile = next((cp for cp in profile.column_profiles if cp.name == 'revenue'), None)
