...
class TestEnhancedSchemaExtraction(unittest.TestCase):
    ...
    def test_sample_data_extraction(self):
        ...
        self.assertEqual(len(users_table.sample_data), 2)  # Should respect sample_rows=2
    ...
    def test_cache_functionality(self):
        ...
        with patch.object(self.extractor, '_extract_schema', return_value=schema1) as mock_extract:
    ...
    def test_cache_ttl(self):
        ...
        with patch.object(extractor, '_extract_schema', return_value=schema1) as mock_extract:
    ...
    def test_sql_validation(self):
        ...
        self.assertTrue(any('not found' in str(e).lower() or 'not exist' in str(e).lower() for e in errors))
    ...
    def test_cache_warming(self):
        ...
        self.assertEqual(len(self.extractor._schema_cache), 2)  # users and orders tables
