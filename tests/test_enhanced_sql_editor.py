...
class TestEnhancedSQLEditor:
    ...
    def mock_db_connection(self):
        ...
        mock = Mock()
        mock.get_table_info = MagicMock(return_value={
            'columns': [
    ...
    def test_format_sql_basic(self, mock_query_engine, mock_db_connection):
        ...
        input_sql = "select * from users where id = 1 and name = 'test' order by created_at"
    ...
    def test_sql_keywords(self):
        ...
        from src.duckdb_analytics.ui.sql_editor import SQL_KEYWORDS, DUCKDB_KEYWORDS
