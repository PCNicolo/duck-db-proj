...
class TestAnalyticsTemplate:
    ...
    def test_generate_query(self):
        ...
        params = {"column1": "revenue", "granularity": "day"}
    ...
    def test_to_dict_and_from_dict(self):
        ...
        assert len(reconstructed.metadata.parameters) == len(
            self.template.metadata.parameters
        )
...
class TestTemplateEngine:
    ...
    def test_execute_template_success(self):
        ...
        result = self.engine.execute_template(
            "Time Series Analysis", parameters, "sales"
        )
