...
from src.duckdb_analytics.ui.smart_pagination import PaginationPresets, SmartPagination
...
class TestAdvancedFilterBuilder:
    ...
    def test_build_condition_equals(self):
        ...
        condition = self.filter_builder._build_condition(
            self.test_df, {"column": "name", "operator": "equals", "value": "Alice"}
        )
    ...
    def test_build_condition_between(self):
        ...
        condition = self.filter_builder._build_condition(
            self.test_df, {"column": "age", "operator": "between", "value": [28, 32]}
        )
        assert condition is not None
    ...
    def test_to_sql_where_clause(self):
        ...
        filter_config = {
            "filters": [{"column": "age", "operator": "greater_than", "value": 25}],
            "logic": "AND",
        }
...
class TestSmartPagination:
    ...
    def setup_method(self):
        ...
        self.test_df = pd.DataFrame(
            {"id": range(1, 101), "value": [i * 2 for i in range(1, 101)]}  # 100 rows
        )
    ...
    def test_get_virtual_scroll_data(self):
        ...
        virtual_data = self.pagination._get_virtual_scroll_data(
            self.test_df, 10, 20, "test"
        )
...
class TestColumnStatisticsManager:
    ...
    def test_analyze_column_quality(self):
        ...
        quality = self.stats_manager._analyze_column_quality(
            self.test_df["numeric_col"]
        )
...
class TestIntegration:
    ...
    def test_component_integration(self):
        ...
        with patch(
            ...
            {
                "filter_builder_filters": [],
                "filter_builder_logic": "AND",
                "column_searches": {},
