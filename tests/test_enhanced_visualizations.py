...
from src.duckdb_analytics.visualizations.dashboard_layout import (
    ChartPosition,
    LayoutType,
)
...
class TestChartTypes:
    ...
    def test_create_radar_chart(self, sample_data):
        ...
        radar_data = (
            sample_data.groupby("category")[["value", "revenue", "count"]]
            .mean()
            .reset_index()
        )
        fig = create_radar_chart(
            radar_data, ["value", "revenue", "count"], "value", "category"
        )
...
class TestPerformanceOptimization:
    ...
    def test_visualization_optimizer(self, sample_data):
        ...
        optimized_df, opt_info = optimizer.optimize_data_for_chart(
            sample_data, "heatmap"
        )
